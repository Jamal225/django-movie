    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveSmallIntegerField(default=0, verbose_name='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('draft', models.BooleanField(default=False, verbose_name='')),
                ('actors', models.ManyToManyField(related_name='film_actor', to='movies.actor', verbose_name='актеры')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.category', verbose_name='')),
